...
from scripts.funcs import logfunc, tsv, open_sqlite_db_readonly

def get_googleMapsMain(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if usageentries > 0:
            report = ArtifactHtmlReport('Google Maps History')
            report.start_artifact_report(report_folder, 'Google Maps History')
            report.add_script()
