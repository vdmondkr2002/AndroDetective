...
def get_gmailEmails(files_found, report_folder, seeker, wrap_text):
    ...
    if bigTopDataDB != '':
        ...
        if usageentries > 0:
            ...
            report.add_script()
            data_headers = ('Timestamp','Email ID','Message','Suspicious','Malware', 'Phishing', 'Risk Score','Attachment','Attachment Name','To','To Name','Reply To','Reply To Name','Subject Line','Mailed By','Signed by')
